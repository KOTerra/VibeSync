...
const spotifyClientId = '9a324ce2de004464916503c99da4c2f2';
const spotifyRedirectUri = 'https://open.spotify.com/playlist/7F1An9VXAFlqFwJHhmeDOo';
...
recommendMoviesButton.addEventListener('click', () => {
  ...
  fetch(tracksApiUrl, {
    ...
    .then(data => {
      ...
      const trackIds = data.items.map(item =>{ const id=item.track.id;
